package com.profteam.controller;
...
public class SendMail 
{
	...
	public static boolean sendMail(String to, String title, String messageSend) throws MessagingException
	{
...
//				return new PasswordAuthentication("tiendqps08547@fpt.edu.vn", "quangtien");
	...
	public static int sendReportExpirationMail() throws SQLException, MessagingException
	{
		int total = 0;
