...
import com.profteam.dao.RentBookDetailDAO;
...
public class UserMainJFrame extends JFrame {
	...
	{
		setIconImage(Toolkit.getDefaultToolkit().getImage(UserMainJFrame.class.getResource(Constants.APP_ICON)));
		...
		tabbedPane.addTab("Tra cứu sách", new ImageIcon(UserMainJFrame.class.getResource("/icon/icons8_books_32px_1.png")), pnlBook, null);
		...
		tabbedPane.addTab("Tra cứu đơn thuê", new ImageIcon(UserMainJFrame.class.getResource("/icon/icons8_bookmark_32px.png")), pnlRentBook, null);
		...
		tabbedPane.addTab("Tra cứu đơn mua sách", new ImageIcon(UserMainJFrame.class.getResource("/icon/icons8_buy_for_change_32px.png")), pnlOrder, null);
