...
public class PublisherJDialog extends JDialog {
	...
	{		
		...
		btnMoi.setIcon(new ImageIcon(CategoryJDialog.class.getResource("/icon/Create.png")));
		pnlControll.add(btnThem);
		btnThem.setHorizontalAlignment(SwingConstants.LEFT);
		btnThem.setIcon(new ImageIcon(CategoryJDialog.class.getResource("/icon/Accept.png")));
		...
		btnCapNhat.setIcon(new ImageIcon(CategoryJDialog.class.getResource("/icon/Notes.png")));
		...
		btnXoa.setIcon(new ImageIcon(CategoryJDialog.class.getResource("/icon/icons8_delete_32px_1.png")));
