...
public class RentBookDetailJDialog extends JDialog {
	...
	{
		setModal(true);
		setIconImage(Toolkit.getDefaultToolkit().getImage(RentBookDetailJDialog.class.getResource("/icon/icons8_details_popup_50px_1.png")));
		...
		btnPrint.setIcon(new ImageIcon(RentBookDetailJDialog.class.getResource("/icon/icons8_print_32px.png")));
