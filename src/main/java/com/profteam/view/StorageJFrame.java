...
import com.profteam.dao.StorageDAO;
...
public class StorageJFrame extends JFrame {
	...
	{
		setTitle("Nhập kho");
		setIconImage(Toolkit.getDefaultToolkit().getImage(StorageJFrame.class.getResource("/icon/icons8_books_64px_4.png")));
		try {
		...
		btnNew.setIcon(new ImageIcon(StorageJFrame.class.getResource("/icon/Create.png")));
		...
		btnSave.setIcon(new ImageIcon(StorageJFrame.class.getResource("/icon/Accept.png")));
		btnSave.setSelectedIcon(new ImageIcon(StorageJFrame.class.getResource("/icon/icons8_add_64px.png")));
		...
		btnUpdate.setIcon(new ImageIcon(StorageJFrame.class.getResource("/icon/Notes.png")));
		...
		btnDelete.setIcon(new ImageIcon(StorageJFrame.class.getResource("/icon/icons8_delete_32px_1.png")));
