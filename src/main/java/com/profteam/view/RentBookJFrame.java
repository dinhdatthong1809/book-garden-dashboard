...
import com.profteam.dao.RentBookDAO;
...
public class RentBookJFrame extends JFrame {
	...
	public RentBookJFrame() 
	{
		...
		setIconImage(Toolkit.getDefaultToolkit().getImage(RentBookJFrame.class.getResource("/icon/icons8_bookmark_64px_2.png")));
		try {
		...
		btnDetail.setIcon(new ImageIcon(RentBookJFrame.class.getResource("/icon/icons8_details_popup_50px_1.png")));
		...
		btnAdd.setIcon(new ImageIcon(RentBookJFrame.class.getResource("/icon/icons8_add_50px_3.png")));
		btnAdd.setSelectedIcon(new ImageIcon(RentBookJFrame.class.getResource("/icon/icons8_add_64px.png")));
		...
		btnEdit.setIcon(new ImageIcon(RentBookJFrame.class.getResource("/icon/icons8_edit_property_50px.png")));
		...
		btnDelete.setIcon(new ImageIcon(RentBookJFrame.class.getResource("/icon/icons8_delete_50px.png")));
		...
		btnGiMailBo.setIcon(new ImageIcon(RentBookJFrame.class.getResource("/icon/icons8_expired_16px.png")));
		...
		btnRefresh.setIcon(new ImageIcon(RentBookJFrame.class.getResource("/icon/icons8_synchronize_24px.png")));
