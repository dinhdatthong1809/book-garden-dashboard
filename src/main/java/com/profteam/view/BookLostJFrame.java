...
import com.profteam.dao.BookLostDAO;
...
public class BookLostJFrame extends JFrame {
	...
	public BookLostJFrame() 
	{
		...
		setIconImage(Toolkit.getDefaultToolkit().getImage(BookLostJFrame.class.getResource("/icon/icons8_buy_for_change_64px_1.png")));
		...
		btnDetail.setIcon(new ImageIcon(BookLostJFrame.class.getResource("/icon/icons8_details_popup_50px.png")));
		...
		btnAdd.setIcon(new ImageIcon(BookLostJFrame.class.getResource("/icon/icons8_add_50px_3.png")));
		...
		btnEdit.setIcon(new ImageIcon(BookLostJFrame.class.getResource("/icon/icons8_edit_property_50px.png")));
		...
		btnDelete.setIcon(new ImageIcon(BookLostJFrame.class.getResource("/icon/icons8_delete_50px.png")));
		...
		label.setIcon(new ImageIcon(BookLostJFrame.class.getResource("/icon/icons8_synchronize_24px.png")));
