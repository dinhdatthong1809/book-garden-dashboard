...
public class AdminJFrame extends JFrame {
	...
	public AdminJFrame() 
	{
		...
		setIconImage(Toolkit.getDefaultToolkit().getImage(AdminJFrame.class.getResource("/icon/icons8_user_groups_64px.png")));
		...
		btnNew.setIcon(new ImageIcon(AdminJFrame.class.getResource("/icon/Create.png")));
		...
		btnSave.setIcon(new ImageIcon(AdminJFrame.class.getResource("/icon/Accept.png")));
		...
		btnUpdate.setIcon(new ImageIcon(AdminJFrame.class.getResource("/icon/Notes.png")));
		...
		btnDelete.setIcon(new ImageIcon(AdminJFrame.class.getResource("/icon/Delete.png")));
		...
		btnXutExcel.setIcon(new ImageIcon(AdminJFrame.class.getResource("/icon/icons8_microsoft_excel_2019_16px.png")));
