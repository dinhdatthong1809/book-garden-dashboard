...
public class LoginJFrame extends JFrame 
{
	...
	public LoginJFrame() {
		setIconImage(Toolkit.getDefaultToolkit().getImage(LoginJFrame.class.getResource(Constants.APP_ICON)));
...
//				System.out.println("localtion: " + (e.getXOnScreen() - posX) +", " + (e.getYOnScreen() - posY));
		...
		lblLogo.setIcon(new ImageIcon(LoginJFrame.class.getResource("/icon/giphy (1).gif")));
		...
		lblNewLabel.setIcon(new ImageIcon(LoginJFrame.class.getResource("/icon/icons8_book_64px_3.png")));
		...
		lblWelcome.setIcon(new ImageIcon(LoginJFrame.class.getResource("/icon/KindlyWickedHoki-max-1mb.gif")));
	...
	{
		int maxHeight = 332;
		lblLogo.setIcon(new ImageIcon(LoginJFrame.class.getResource("/icon/sunrise-400.gif")));
