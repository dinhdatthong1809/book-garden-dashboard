...
public class UserJFrame extends JFrame {
	...
	public UserJFrame() 
	{
		...
		setIconImage(Toolkit.getDefaultToolkit().getImage(UserJFrame.class.getResource("/icon/icons8_user_groups_64px.png")));
		...
		btnTaoMoi.setIcon(new ImageIcon(UserJFrame.class.getResource("/icon/Create.png")));
		...
		btnThem.setIcon(new ImageIcon(UserJFrame.class.getResource("/icon/Accept.png")));
		...
		btnCpNht.setIcon(new ImageIcon(UserJFrame.class.getResource("/icon/Notes.png")));
		...
		btnXa.setIcon(new ImageIcon(UserJFrame.class.getResource("/icon/Delete.png")));
