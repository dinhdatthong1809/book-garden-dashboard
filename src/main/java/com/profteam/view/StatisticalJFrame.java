...
import com.profteam.dao.StatisticDAO;
...
public class StatisticalJFrame extends JFrame {
	...
	public StatisticalJFrame() 
	{
		...
		tabbedPane.addTab("Thống Kê Chung", new ImageIcon(StatisticalJFrame.class.getResource("/icon/icons8_online_store_32px.png")), pnlChung, null);
		...
		lblIcon.setIcon(new ImageIcon(StatisticalJFrame.class.getResource("/icon/icons8_buy_80px.png")));
		...
		label_3.setIcon(new ImageIcon(StatisticalJFrame.class.getResource("/icon/icons8_bookmark_80px_1.png")));
		...
		label_6.setIcon(new ImageIcon(StatisticalJFrame.class.getResource("/icon/icons8_books_80px.png")));
		...
		label_10.setIcon(new ImageIcon(StatisticalJFrame.class.getResource("/icon/icons8_user_80px.png")));
		...
		label_15.setIcon(new ImageIcon(StatisticalJFrame.class.getResource("/icon/icons8_box_important_3_80px.png")));
		...
		label_16.setIcon(new ImageIcon(StatisticalJFrame.class.getResource("/icon/icons8_stack_of_money_80px.png")));
		...
		tabbedPane.addTab("Sách Bán", new ImageIcon(StatisticalJFrame.class.getResource("/icon/icons8_books_32px_1.png")), pnlSachBan, null);
		...
		btlReloadOrder.setIcon(new ImageIcon(StatisticalJFrame.class.getResource("/icon/icons8_synchronize_24px.png")));
