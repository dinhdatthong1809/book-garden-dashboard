...
public class MainJFrame extends JFrame {
	...
	public MainJFrame()
	{
		...
		setIconImage(Toolkit.getDefaultToolkit().getImage(MainJFrame.class.getResource(Constants.APP_ICON)));
		...
		lblTItle1.setIcon(new ImageIcon(MainJFrame.class.getResource("/icon/icons8_books_32px_1.png")));
		...
		lblNhnVin.setIcon(new ImageIcon(MainJFrame.class.getResource("/icon/icons8_buy_for_change_32px.png")));
		...
		lblKhchHng.setIcon(new ImageIcon(MainJFrame.class.getResource("/icon/icons8_bookmark_32px.png")));
		...
		lblHan.setIcon(new ImageIcon(MainJFrame.class.getResource("/icon/icons8-health-book-32.png")));
		...
		lblCuHnh.setIcon(new ImageIcon(MainJFrame.class.getResource("/icon/icons8_user_group_man_woman_32px.png")));
		...
		lblThu.setIcon(new ImageIcon(MainJFrame.class.getResource("/icon/icons8_statistics_32px.png")));
		...
		lblNhnVin_1.setIcon(new ImageIcon(MainJFrame.class.getResource("/icon/icons8_user_credentials_32px.png")));
		...
		lblngXut.setIcon(new ImageIcon(MainJFrame.class.getResource("/icon/icons8_exit_32px.png")));
		...
		lblLogo.setIcon(new ImageIcon(MainJFrame.class.getResource("/icon/icons8_book_64px_3.png")));
		...
		lblNhpKho.setIcon(new ImageIcon(MainJFrame.class.getResource("/icon/icons8_move_by_trolley_32px.png")));
		...
		lblCicleAvatar.setIcon(new ImageIcon(MainJFrame.class.getResource("/icon/cicleAvatar.png")));
		...
		lblBGFrameAvatar.setIcon(new ImageIcon(MainJFrame.class.getResource("/icon/frame2.png")));
		...
		lblCic.setIcon(new ImageIcon(MainJFrame.class.getResource("/icon/icons8_settings_32px_1.png")));
	...
	public void showInfoAdmin()
	{
		...
		{ //set avatar mặc định nếu admin không có image
			lblAvatar.setIcon(new ImageIcon(getClass().getResource("/icon/avatar-default.png")));
			SwingHelper.setAutoResizeIcon(lblAvatar);
		}
	}
