...
import com.profteam.model.RentBookDetail;
...
public class BookLostDetailJDialog extends JDialog {
	...
	{
		setModal(true);
		setIconImage(Toolkit.getDefaultToolkit().getImage(BookLostDetailJDialog.class.getResource("/icon/icons8_details_popup_50px_1.png")));
		...
		btnPrint.setIcon(new ImageIcon(BookLostDetailJDialog.class.getResource("/icon/icons8_print_32px.png")));
