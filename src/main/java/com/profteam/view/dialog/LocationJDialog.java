...
public class LocationJDialog extends JDialog {
	...
	public LocationJDialog() 
	{
		...
		setIconImage(Toolkit.getDefaultToolkit().getImage(CategoryJDialog.class.getResource("/icon/icons8_medium_priority_50px.png")));
		try {
		...
		btnThm.setIcon(new ImageIcon(CategoryJDialog.class.getResource("/icon/Accept.png")));
		...
		btnCpNht.setIcon(new ImageIcon(CategoryJDialog.class.getResource("/icon/Notes.png")));
		...
		btnXa.setIcon(new ImageIcon(CategoryJDialog.class.getResource("/icon/icons8_delete_32px_1.png")));
		...
		btnMi.setIcon(new ImageIcon(CategoryJDialog.class.getResource("/icon/Create.png")));
		...
		btnXutExcel.setIcon(new ImageIcon(LocationJDialog.class.getResource("/icon/icons8_microsoft_excel_2019_16px.png")));
